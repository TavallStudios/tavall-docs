...
- The lane has one existing DEVELOPMENT Environment; no alternate Environment with the rollout snapshot is available. It was re-resolved to `f9d408421b1d5f8f1dbfc4afca44e084ed181f63b85168099bba073993cbc74d` to bind current Cloud PR head `a6a34717`, preserving DURABLE / DEDICATED / SHARED / inherited resource policy.
...
- The Environment-owned Cloud checkout is clean at `main@2f1c94b47d38d86a1724067c0ab8be39bd512178`, while the current snapshot pins `tavall-cloud@a6a3471733f5628c44fefd58c09aa2c48813b748`. The Architecture Tests shared dependency is present clean at the exact pinned `c0863bfe9e3ea38e4872eb295856e69bed30eb28`.
...
- These tests have not run at commit `a6a34717`. The Cloud `.tavallci` runtime profile declares `tavall-cloud-agent` from the existing self-contained `:tavall-cloud-node:allJar` task, which has not been built or published.
