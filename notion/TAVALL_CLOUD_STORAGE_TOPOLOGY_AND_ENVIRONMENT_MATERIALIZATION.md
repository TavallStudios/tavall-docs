...
- **LIVE STATE:** Environment `5848c5ff-a2a2-4da4-bd25-9cff8e558433` resolves to source snapshot `f9d408421b1d5f8f1dbfc4afca44e084ed181f63b85168099bba073993cbc74d`, but its observed state remains `BLOCKED`; workspace and development-tool components are `UNKNOWN`. The installed Agent/CLI predates the new plan-bound job and Storage evidence commands, so this change has not yet persisted live CI evidence.
...
- The Environment source snapshot advanced from `b6a8b43b314ad2a5b017f271f4974d9562327d13ef66d132ccf14ccca2ea7484` through `fdb68123ba248ed2e3c83a781720ac9ea8cca043d594f402d3c6a00656b0eabb` and `a2fbe1f926366e39a4302d4708a76c638f94e214fa18b5aa8a8fc301f9e386c1` to `f9d408421b1d5f8f1dbfc4afca44e084ed181f63b85168099bba073993cbc74d`, preserving DURABLE / DEDICATED / SHARED / inherited resource policy and pinning Cloud PR #395 head `a6a3471733f5628c44fefd58c09aa2c48813b748`.
- The live TCI checkout is clean at `ef59a10f97668bf38f47616649353e8cca1199bb` instead of pinned `a6872ae4366434da2308529b7e60a1497469c466`; the live Cloud checkout is clean at `main@2f1c94b47d38d86a1724067c0ab8be39bd512178` instead of pinned `a6a3471733f5628c44fefd58c09aa2c48813b748`. The Architecture Tests shared dependency is present at `c0863bfe9e3ea38e4872eb295856e69bed30eb28`.
...
- Cloud PR #395 commit `a6a3471733f5628c44fefd58c09aa2c48813b748` aligns Cloud template identity to TCI's canonical `services/<service-id>` identity. The live control template uses identity `services/tavall-cloud-control` and retains template digest `5033fa2b198c3f6c47065eb3e2db202d9203048a350fcda9a240c195b570c9fa`.
- Tests cover generation links, stale source preservation, primary selection, and template identity alignment. They have not run at `a6a34717`; the Environment cannot execute the source until its Agent/materialization path is updated. No CI evidence, artifact, bundle, or deployment has been produced.
