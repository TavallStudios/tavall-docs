...
- **LIVE STATE:** Environment `5848c5ff-a2a2-4da4-bd25-9cff8e558433` resolves to source snapshot `b6a8b43b314ad2a5b017f271f4974d9562327d13ef66d132ccf14ccca2ea7484`, but its observed state remains `BLOCKED`; workspace and development-tool components are `UNKNOWN`. The installed Agent/CLI predates the new plan-bound job and Storage evidence commands, so this change has not yet persisted live CI evidence.
