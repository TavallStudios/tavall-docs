...
- **LIVE STATE:** Environment `5848c5ff-a2a2-4da4-bd25-9cff8e558433` now resolves to snapshot `29ce13c6e19db68a295f4106e728044f7febda8375a47aff85ae1f64121ef694`, but its observed state remains `BLOCKED`; workspace and development-tool components are `UNKNOWN`. The installed Agent/CLI predates the new Storage commands, so this change has not yet persisted live CI evidence.
